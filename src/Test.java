...
public class Test {
    ...
    static void test7() {
        ...
        for (int i = 2000; i < 2500; i++) {
            fibonacciHeap.checkParent();
            System.out.println("find min :"+ heap.findMin()+" fib min: "+fibonacciHeap.findMin());
    ...
    static void test9() {
        ...
        for (int i = 2700; i > 2200; i--) {
            System.out.println("this is true min: "+heap.findMin()+" this is fib min "+fibonacciHeap.findMin());
            if (heap.findMin() != fibonacciHeap.findMin().getKey() || heap.size() != fibonacciHeap.size()) {
                System.out.println("this is bug1");
                bugFound(test);
                return;
            }
            heap.delete(i);
        ...
        while (!heap.empty()) {
            if (heap.findMin() != fibonacciHeap.findMin().getKey() || heap.size() != fibonacciHeap.size()) {
                System.out.println("this is bug2");
                bugFound(test);
                return;
            }
            heap.deleteMin();
    ...
    static void test22() {
            ...
            noCascading)
        {
            ...
            System.out.println("this is number of trees "+fibonacciHeap.numberOfTrees());
            System.out.println("this is potential "+fibonacciHeap.potential());
            System.out.println("this is total cuts: "+(fibonacciHeap.totalCuts()-totalCuts));
            System.out.println("this is total links "+(fibonacciHeap.totalLinks()-links));
            System.out.println("this is countersRep: "+ Arrays.toString(fibonacciHeap.countersRep()));
            bugFound(test);
